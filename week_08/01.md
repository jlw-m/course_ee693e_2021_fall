...
##Audience Questions
Does the environment reflection affect snr in the mirror? like having a brick vs wood wall?

What is the bare minimum number of mirrors needed for the system to completely cover the room?

Do you believe that having multiple receivers on the headset eliminates the need for mirrors?

They conducted the experiment in a 5x5 room. Do you think it would impact the blockage problems if the room size was different (bigger/smaller)? 
