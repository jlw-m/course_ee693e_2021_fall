...
However, if the telemedicine curriculum the authors mentioned go mainstream, we can have a new field of experts who specialized on using technology to treat patients remotely. This new field can grow into its own indutry like the software industry did in the new millenium. We could have new jobs we have not imagined yet (parallel to software engineers, DevOps ...). The pandemic has shown there is a need for tele-medicine and incorporating it into the curriculum would create medical professionals that are better equiped for a future pandemic.
